        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#trending" className="text-gray-700 hover:text-blue-600 transition-colors">
                Trending
              </a>
        ...
        {isMenuOpen && (
          ...
          >
            <div className="px-4 py-2 space-y-2">
              ...
              <a href="#trending" className="block py-2 text-gray-700 hover:text-blue-600">
                Trending
              </a>
              <a href="#categories" className="block py-2 text-gray-700 hover:text-blue-600">
                Categories
              </a>
