...
export function CheckoutSidebar({ product, quantity, onClose, onQuantityChange }: CheckoutSidebarProps) {
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <Select value={shippingMethod} onValueChange={setShippingMethod}>
              ...
              <SelectContent>
                <SelectItem value="standard">Standard Shipping - $5.99 (5-7 days)</SelectItem>
                <SelectItem value="express">Express Shipping - $15.99 (2-3 days)</SelectItem>
              </SelectContent>
            </Select>
          </CardContent>
        </Card>
